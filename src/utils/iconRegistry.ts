/**
 * Icon Registry - List of all available Pixelarticons
 * 
 * This file contains all available icon names from the Pixelarticons set.
 * These can be used with the Icon component.
 */
